...
from model_before import build_model
...
DATA_FILE_PATH = 'data/train/train_final_with_onehot_20150102_20250812_with_diff.xlsx'
MODEL_DIR = 'models'
MODEL_EXT = '.ckpt'
...
if __name__ == "__main__":
    ...
    exchange_rate = df['target'].values.reshape(-1, 1)
